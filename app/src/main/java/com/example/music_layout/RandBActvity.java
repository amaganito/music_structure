...
public class RandBActvity extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            musics.add(new Music("R&BArtist" + i, "SongTitle" + i));
            i++;
        }
        ...
        library.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mainIntent = new Intent(RandBActvity.this, MainActivity.class);
